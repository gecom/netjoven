                    ...
                    <div class="tab-pane fade in active" id="register_publication">
                        <form id="frm_news_register" enctype="multipart/form-data" accept-charset="UTF-8" method="post" action="{{ ($is_new == true ? route('backend.register.save.new') : route('backend.register.save.edit', array('news_id'=> $dbr_post->id))) }}"  autocomplete="off">
                            <div class="col-lg-7">
                                ...
                                <div id="wrapper_video" class="row" style="display: {{(!$is_new && $dbr_post->type == Helpers::TYPE_POST_VIDEO ? 'block' : 'none' )}}">
                                    <div class="col-lg-6">
                                        <div class="form-group ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 pull-right">
                                        ...
                                        <div id="wrapper_is_recommended" class="checkbox" style="display: {{(!$is_new && $dbr_post->type == Helpers::TYPE_POST_VIDEO ? 'block' : 'none')}} ">
                                            <label>
                                            {{ Form::checkbox('frm_news[is_recommended]', '1', ($is_new ? false : ($dbr_post->is_recommended == '1' ? true : false))) }} Recomendado
                                            </label>
                                        </div>
                                    </div>
                                </div>
