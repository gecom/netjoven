        ...
        <div class="row">
             <div class="col-lg-12">
                <form id="frm_post_featured" enctype="multipart/form-data" accept-charset="UTF-8" method="post" action="{{route('backend.register.save.featured', $dbl_post->id)}}"  autocomplete="off">
                    ...
                    @if ($dbl_post->type == Helpers::TYPE_POST_VIDEO)
                        {{ Form::hidden('frm_post_featured[is_video]', 1, array('id' => 'frm_post_featured_is_video')) }}
                    @endif
                    <div class="col-lg-7">
                        @if ($dbl_post->type == Helpers::TYPE_POST_NEWS)
