						...
						<div class="row">
							<div class="col-lg-4 ">
							    <div class="form-group">
									...
									<select class="form-control" id="frm_statistics_filter_users" name="frm_statistics_filter[users]"></select>
							    </div>
							</div>								
							<div class="col-lg-4 form-group">
								<label for="frm_statistics_filter_categories">Categorias</label>                                    					
								<select class="form-control" id="frm_statistics_filter_categories" name="frm_statistics_filter[categories]"></select>
							</div>
							<div class="col-lg-4 form-group">
								<label for="frm_statistics_filter_subcategories">Sub categorias</label>                                    					
								<select class="form-control" id="frm_statistics_filter_subcategories" name="frm_statistics_filter[subcategories]"></select>
							</div>
						</div>
						<div class="row ">
							<div class="col-md-12">
