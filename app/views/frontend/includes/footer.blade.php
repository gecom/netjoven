<nav id="footer_nav">
    <ul>
        <li><a href="#"><span class="icon"></span>INICIO</a></li><li><a href="#"><span class="icon"></span>ESPECTÁCULOS</a></li><li><a href="#"><span class="icon"></span>DEPORTES</a></li><li><a href="#"><span class="icon"></span>ACTUALIDAD</a></li><li><a href="#"><span class="icon"></span>GAMERS</a></li><li><a href="#"><span class="icon"></span>ESTILO DE VIDA</a></li><li><a href="#"><span class="icon"></span>NETJOVEN TV</a></li>
    </ul>
</nav>
