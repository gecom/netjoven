...
-- -----------------------------------------------------
-- Table `netjoven`.`njv_news`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `netjoven`.`njv_news` (
  `id` INT(11) NOT NULL,
  ...
  `comment` INT(5) NULL DEFAULT NULL,
  `ip` VARCHAR(24) NOT NULL,
  `status` CHAR(3) NOT NULL DEFAULT 'act',
  `view_index` INT(2) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_nej_publish_nej_user1_idx` (`user_id` ASC),
  INDEX `fk_njv_publish_njv_category1_idx` (`category_id` ASC),
  CONSTRAINT `fk_nej_publish_nej_user1`
    FOREIGN KEY (`user_id`)
...
CREATE TABLE IF NOT EXISTS `netjoven`.`njv_comment` (
  ...
  `created_at` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_njv_comment_njv_publish1_idx` (`news_id` ASC),
  CONSTRAINT `fk_njv_comment_njv_publish1`
    FOREIGN KEY (`news_id`)
    REFERENCES `netjoven`.`njv_news` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `netjoven`.`njv_news_featured`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `netjoven`.`njv_news_featured` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `category_id` INT(11) NULL DEFAULT NULL,
  `news_id` INT(11) NOT NULL,
  ...
  INDEX `fk_njv_publish_featured_njv_publish1_idx` (`news_id` ASC),
...
-- -----------------------------------------------------
-- Table `netjoven`.`njv_news_tag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `netjoven`.`njv_news_tag` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `news_id` INT(11) NOT NULL,
  `tag_id` INT(11) NOT NULL,
  `created_at` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_njv_news_tag_njv_news1_idx` (`news_id` ASC),
...
-- -----------------------------------------------------
-- Table `netjoven`.`njv_publish_multimedia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `netjoven`.`njv_publish_multimedia` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `news_id` INT(11) NOT NULL,
  ...
  `created_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_njv_gallery_photos_njv_publish1_idx` (`news_id` ASC),
...
CREATE TABLE IF NOT EXISTS `netjoven`.`njv_theme_day` (
  ...
  `created_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_nej_theme_day_nej_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_nej_theme_day_nej_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `netjoven`.`njv_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
